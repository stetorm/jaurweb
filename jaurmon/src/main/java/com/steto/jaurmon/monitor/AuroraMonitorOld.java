...
public class AuroraMonitorOld {
    ...
    public AuroraMonitorOld(AuroraDriver auroraDriver, String configFile, String dataLogDirPath) throws IOException, SerialPortException {
